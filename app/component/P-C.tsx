...
const About = () => {
  return (
    ...
    <div className='pl-72 pt-14 pb-4   w-full text-white  '>
      <h2 className='text-[40px] leading-none uppercase'>Capturing the essence of your love story in<br /> it’s most breathtaking form</h2>
      <div className='w-[600px] mt-8 uppercase text-xs'>
    ...
    <div className='relative w-full h-full '>
      ...
      <div className='absolute inset-0 bg-gradient-to-t from-transparent to-black h-[150px] '>
        <div className='text-slate-50 pt-48'>
          <p className=' text-[20px]   font-[150] pl-[100px] tracking-widest  '>VIEW OUR</p>
  ...
  <div className='relative w-full h-full mt-5'>
    ...
    <div className='absolute inset-0 bg-gradient-to-b from-transparent to-black h-'>
      <div className='text-slate-50 pt-48'>
        <p className=' text-[20px]   font-[150] pl-[605px] tracking-widest  '>VIEW OUR</p>
